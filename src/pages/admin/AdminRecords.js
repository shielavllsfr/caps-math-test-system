                    ...
                    .then((testStatus) => {
                        ...
                        .then((testResponseData) => {
                            ...
                            .then((userInfo) => {
                                ...
                                tempArr.push(createData(userInfo.data().userInfo.name, userInfo.data().userInfo.course, userInfo.data().userInfo.year, testResponseData.data().score, status, surveyResponse.id))
    ...
    return(
        <Grid>
            ...
            <Grid style={{ marginTop: '15vh' }}>
                <Typography variant='h5' style={{ textAlign: 'center' }}>STUDENT'S RECORDS</Typography>
                <Grid style={{ display: 'flex', justifyContent: 'center', marginTop: '5vh'}} >
                    <TextField onChange={searchValue} placeholder='Search' style={{ width: '80%', borderWidth: '10px'  }}/>
                </Grid>
                        ...
                        <Table stickyHeader aria-label="sticky table">
                          ...
                          <TableBody>
                            ...
                            .filter(filterNames)
                              .map((row) => {
                                return (
                                  <TableRow hover role="checkbox" tabIndex={-1} key={row.course} onClick={rowClicked} id={row.surveyId}>
                                  {columns.map((column) => {

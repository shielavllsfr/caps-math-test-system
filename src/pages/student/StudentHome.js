      ...
      <Grid>
        ...
        <Grid className={classes.flex}>
          ...
          <Grid className={classes.rightFlex}>
            <Typography variant="h2" style={{ margin: "17vh 0vh 2vh 15vh" }}>
              We want to measure your mathematical skill in able to help you!
            </Typography>
            <Button
              component={Link}
              to="/test-survey"
          ...
          <Grid style={{ display: "flex", marginLeft: "2vh" }}>
            <Grid className={classes.leftMath}>
              ...
              <Typography variant="h5">
                <span className={classes.spans}>M</span>ental
              </Typography>
              <Typography variant="h5">
                <span className={classes.spans}>A</span>buse
              </Typography>
              <Typography variant="h5">
                <span className={classes.spans}>T</span>o
              </Typography>
              <Typography variant="h5">
                <span className={classes.spans}>H</span>umans
              </Typography>
              {vote ? (
                <LinearProgressWithLabel value={voteCount.abusePercentage} />
              ) : (
                <Button
                  variant="contained"
                  color="success"
            ...
            <Grid className={classes.rightMath}>
              <Typography variant="h3">MATH IS...</Typography>
              <Typography variant="h5">
                <span className={classes.spans}>M</span>ore
              </Typography>
              <Typography variant="h5">
                <span className={classes.spans}>A</span>ddictive
              </Typography>
              <Typography variant="h5">
                <span className={classes.spans}>T</span>han
              </Typography>
              <Typography variant="h5">
                <span className={classes.spans}>H</span>eroin
              </Typography>
              {vote ? (
                <LinearProgressWithLabel value={voteCount.drugsPercentage} />
              ) : (
                <Button
                  variant="contained"
                  color="success"

...
export default function Test() {
  ...
  useEffect(() => {
    const generatePageData = () => {
      ...
      if (
        localStorage.getItem("user-answers") !== "" &&
        localStorage.getItem("survey-respond") !== ""
      ) {
        firebase
          .firestore()
          .collection("test")
          ...
          .then((questionData) => {
            ...
            setTestRes({
              ...
              percentage:
                (correctAnswers / questionData.data().correctAnswer.length) *
                100,
              sufficient: checkSufficientPercentage(
                (correctAnswers / questionData.data().correctAnswer.length) *
                  100
              ),
            });
                      ...
                      .then((userInfo) => {
                        firebase
                          ...
                          .add({
                            ...
                            score: correctAnswers + "",
                            totalItems:
                              questionData.data().correctAnswer.length,
                            percentage:
                              (correctAnswers /
                                questionData.data().correctAnswer.length) *
                              100,
                          ...
                          .then((test) => {
                            ...
                            firebase
                              ...
                              .then(() => {
                                ...
                                const recommendationsCollection = firebase
                                  .firestore()
                                ...
                                if (
                                  ...
                                  recommendationsCollection
                                    ...
                                    .then((suffiData) => {
                                      suffiData
                                        .data()
                                        .sufficientValues.forEach(
                                          (suffiValue) => {
                                            const recommendationObj = (
                                              <Typography
                                                variant="h5"
                                                key={count}
                                                className={classes.recoMargin}
                                              >
                                                {count}. {suffiValue}
                                              </Typography>
                                            );
        ...
        firebase
          ...
          .then((response) => {
            ...
            if (response.data() === undefined) {
              setSnackMessage({
                type: "error",
                message: "No result for this user is found",
              });
              handleSnack();
              setLoading(false);
            } else {
              firebase
                ...
                .then((responseData) => {
                  ...
                  let tempReco = [];
                  if (
                    checkSufficientPercentage(responseData.data().percentage)
                  ) {
                    recommendationsCollection
                      .doc("sufficient")
                      .get()
                      .then((suffiData) => {
                        suffiData
                          .data()
                          .sufficientValues.forEach((suffiValue) => {
                            const recommendationObj = (
                              <Typography
                                variant="h5"
                                key={count}
                    ...
                    recommendationsCollection
                      ...
                      .then((insuData) => {
                        insuData
                          .data()
                          .insufficientValues.forEach((insuValue) => {
                            const recommendationObj = (
                              <Typography
                                variant="h5"
                                key={count}
  ...
  const renderRecommendation = (elements) => {
    if (recommendationContainer.current !== undefined)
      reactDom.render(elements, recommendationContainer.current);
  };
    ...
    return (
      <Grid style={{ marginTop: "15vh" }}>
        ...
        <Grid style={{ textAlign: "center" }}>
          <Button className={classes.view} id="survey" variant="text" disabled>
            TEST RESULT
          </Button>
        </Grid>
  ...
  return (
    <Grid style={{ marginTop: "15vh" }}>
      ...
      <Grid ref={ref}>
          ...
          <Grid style={{ display: "flex", justifyContent: "center" }}>
            ...
            >
              ...
              <Grid>
                ...
                <Typography variant="h5">
                  COURSE & YEAR: {stdInfo.year} - {stdInfo.course}
                </Typography>
              </Grid>
            </Grid>
            <Grid
            ...
            >
              ...
              <Typography variant="h4">
                {testRes.score}/{testRes.totalItems}
              </Typography>
        ...
        >
          <Typography variant="h5" className={classes.paraMargin}>
            You have {testRes.sufficient ? "sufficient" : "insufficient"}{" "}
            knowledge in Mathematics. You may improve your knowledge more by
            following these steps:
          </Typography>

          <Container ref={recommendationContainer}></Container>

          <Typography variant="h5" className={classes.paraMargin}>
            Review your test by clicking the review button and you may download
            it by clicking the download button. Thank you for participating, we
            appreciated it.
          </Typography>
          ...
          >
            ...
            <Pdf
              ...
              x={-20}
              y={20}
              filename={stdInfo.name + " results.pdf"}
            >
              {({ toPdf }) => (
                <Button
                  disabled={disableBtn}

    ...
    firebase
      ...
      .catch((e) => {
        setSnackMessage({
          type: "error",
          message:
            "Something went wrong trying to load the test, please notify the admin",
        });
        handleSnack();
      });
  };
  ...
  return (
    <Grid style={{ marginTop: "15vh" }}>
      ...
      <Grid style={{ textAlign: "center" }}>
        ...
        >
          <Typography variant="h3" style={{ textAlign: "left", margin: "5vh" }}>
            Solve the Following
          </Typography>
          {questions.questions.map((data) => (
            <Container
              style={{ margin: "3vh 8vh", textAlign: "left" }}
            ...
            >
              ...
              <FormControl component="fieldset">
                ...
                >
                  <FormControlLabel
                    value="a"
                    control={<Radio id={data.questionCount + ""} />}

    ...
    return(
        <Grid>
            ...
            <Box sx={{ flexGrow: 1, bgcolor: 'background.paper', display: 'flex', height: '100%', marginTop: '15vh' }}>
                ...
                >
                  <Tab label="EDIT PROFILE" className={classes.tabLabel} {...a11yProps(0)} />
                  <Tab label="CHANGE PASSWORD" className={classes.tabLabel} {...a11yProps(1)} />
                </Tabs>
                <TabPanel value={value} index={0}>
                    ...
                    <Grid style={{ width: '160vh', height: '78vh', border: '1px solid black'}}>
                        <Grid style={{  display: 'flex', justifyContent: 'center', marginTop: '3vh' }}>
                            <Typography variant='h5'>PERSONAL PROFILE</Typography>
                        </Grid>

                        <Grid style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', marginTop: '5vh', marginBottom: '5vh' }}>
                            ...
                            <Grid>
                                <Link href="#" variant="body2" component="label" className={classes.profileHover}>
                                <Avatar src={userInfoValues.avatarUrl}
                                style={{ 
                                    height: '17vh',
                                    width: '17vh',
                        ...
                        <Grid style={{ marginLeft: '20vh' }}>
                            ...
                            <TextField variant='outlined' className={classes.fieldSize} value={userInfoValues.contact} id='contact' onChange={handleAddAndCont}/>
                            <Typography><b>Address:</b></Typography>
                            <TextField variant='outlined' className={classes.fieldSize} value={userInfoValues.address} id='address' onChange={handleAddAndCont}/>

                          <Grid className={classes.leftSide} sx={{ display: 'flex' }}>
                            <Typography style={{ marginRight: '6.5vh' }}><b>Course:</b></Typography>
                        ...
                        <Grid style={{ display: 'flex', justifyContent: 'center', marginTop: '3vh' }}>
                          <Button variant='contained' color='success' id='profile' onClick={submitChanges}>SUBMIT</Button>
                        </Grid>
                  ...
                  <Grid style={{ display: 'flex', width: '160vh', height: '78vh', border: '1px solid black' }}>
                    <Grid style={{ width: 'inherit'  }}>
                        ...
                        <Grid style={{ display: 'flex', justifyContent: 'center' }}>
                          <Button variant='contained' color='success' id='password' onClick={submitChanges}>SUBMIT</Button>
                        </Grid>
                    </Grid>
                  </Grid>
                </TabPanel>

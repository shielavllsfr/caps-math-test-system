...
export default function Survey() {
    ...
    firebase
      ...
      .then((questions) => {
        if (questions.data() !== undefined) {
          ...
          setSnackMessage({
            type: "error",
            message: "There are currently no survey",
          });
          handleSnack();
        }
      });
  ...
  const radioChanged = (e) => {
    ...
    if (responses[index] == null) {
      ...
      if (responses[index] !== e.target) {
        ...
        prevResponse[index].parentElement.setAttribute(
          "class",
        ...
        prevResponse[index].parentElement.children[1].lastChild.setAttribute(
          "class",
          "MuiSvgIcon-root MuiSvgIcon-fontSizeMedium css-1hhw7if-MuiSvgIcon-root"
        );
        responses[index].checked = true;
        responses[index].parentElement.setAttribute(
          "class",
        ...
        responses[index].parentElement.children[1].lastChild.setAttribute(
          "class",
  ...
  const nextClicked = () => {
    ...
    if (notEmpty === responses.length) {
      ...
      setSnackMessage({
        type: "error",
        message: "Please don't leave any question empty",
      });
      handleSnack();
    }
  };
      ...
      <Grid style={{ marginTop: "15vh" }}>
        ...
        <Grid style={{ textAlign: "center" }}>
          ...
          >
            <Typography
              variant="h5"
              style={{ textAlign: "left", margin: "5vh" }}
            >
              You've already responded to the survey and test. You can go the
              the "RESULT" section to see your test result again
            </Typography>
          </Grid>
        </Grid>
      </Grid>
  ...
  return (
    <Grid style={{ marginTop: "15vh" }}>
      ...
      <Grid style={{ textAlign: "center" }}>
        ...
        >
          <Typography variant="h5" style={{ textAlign: "left", margin: "5vh" }}>
            Below is the list of statements that measires your attitude towards
            Mathematics. Please indicate how strongly you agree or disagree with
            each statement.
          </Typography>
          <Container
            style={{ justifyContent: "left", margin: "3vh 8vh" }}
            ref={container}
          >
